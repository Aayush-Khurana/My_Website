...
### This particular challenge involved estimating the average cost for 2 people to stay in an AirBnB in Amsterdam for 4 nights. Unlike the other 2 challenges, this project involved taking raw data from Airbnb and, using our skillsets in Data wrangling and manipulation, create a regression model to create a sound prediction of the estimated price. 
